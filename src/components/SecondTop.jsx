...
const SecondTop = () => {
  ...
  return (
   <main>
         <section className='relative flex items-center justify-between mx-5 px-[100px] py-5 border-b border-t'>
        {/* left part */}
        <div className='flex flex-col gap-6'>
            <img src={photo} alt="" className='w-[500px] h-[400px] rounded-xl'/>
            <p className='font-bold text-[28px] w-[500px] '>Lenovo`s smarter devices stoke  professional passions</p>
